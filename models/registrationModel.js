...
module.exports = {
    ...
    insert: function(user, callback) {
        var sql = "INSERT INTO `user`( `name`, `email`,`username`, `password`, `type`, `dp`, `status`) VALUES ('" + user.name + "','" + user.email + "','" + user.username + "','" + user.password + "','" + user.type + "','" + user.dp + "','" + user.status + "')";
